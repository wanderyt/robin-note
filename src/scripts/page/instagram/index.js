...
import {ImageOverlayWithDesc} from "../../uikit/overlay";
import ImageContainer from '../../uikit/image-container';
import UIButton from '../../uikit/button';
import UISearchBox from '../../uikit/search-box';
import {ids as InsList} from './config.json';
